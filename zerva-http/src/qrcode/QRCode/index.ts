...
export default class QRCode {
  ...
  makeImpl(test: boolean, maskPattern: number) {
    ...
    if (this.dataCache === null) {
      this.dataCache = (QRCode as any).createData(this.typeNumber, this.errorCorrectLevel, this.dataList)
    }
  ...
  static createData(typeNumber: number, errorCorrectLevel: any, dataList: any[]) {
